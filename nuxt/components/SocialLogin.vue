    ...
    <ul>
        ...
        <li>
            <v-btn block class="color-facebook text-capitalize mb-3" @click="facebookLogin()">
                <v-icon left class="color-facebook__icon" size="22">mdi-facebook</v-icon>
                Facebookアカウントでログイン
            </v-btn>
        </li> -->
        <li>
